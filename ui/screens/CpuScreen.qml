    ...
    StackLayout {
        ...
        Item { RowLayout { anchors.fill:parent; spacing:14
            ...
            ColumnLayout { Layout.fillWidth:true; Layout.fillHeight:true
                Rectangle { Layout.fillWidth:true; Layout.preferredHeight:230; color:Theme.inset; radius:Theme.radiusCard; border.width:1; border.color:Theme.border; HistoryGraph{anchors.fill:parent;anchors.margins:8;samples:app.cpuHistory;fixedMax:100;scaleMode:app.yScaleMode;scaleMultiplier:app.graphYScale;fps:app.graphFps;paused:app.paused} Text{anchors.right:parent.right;anchors.top:parent.top;anchors.margins:14;text:Number(app.cpuUsage).toFixed(1)+"%";color:Theme.textBright;font.family:Theme.monoFont;font.pixelSize:20} }
