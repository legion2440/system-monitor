...
Flickable {
    ...
    ColumnLayout {
        ...
        GridLayout {
            ...
            MetricCard { Layout.columnSpan:2; Layout.fillWidth:true; Layout.preferredHeight:184; kicker:qsTr("PROCESSOR"); subtitle:app.cpuModel; value:Number(app.cpuUsage).toFixed(1); unit:"%"; HistoryGraph { anchors.fill:parent; samples:app.cpuHistory; fixedMax:100; scaleMode:"Fixed"; fps:app.graphFps; paused:app.paused } }
