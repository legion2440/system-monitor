...
QVariant SensorModel::data(const QModelIndex& index,int role) const{
    ...
    switch(role){case NameRole:return QString::fromStdString(s.name);case SourceRole:return QString::fromStdString(s.source);case UnitRole:return QString::fromStdString(s.unit);case ValueRole:return s.value;default:return{};}
}
QHash<int,QByteArray> SensorModel::roleNames() const{return{{NameRole,"name"},{SourceRole,"source"},{UnitRole,"unit"},{ValueRole,"value"}};}
